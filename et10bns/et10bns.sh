...
python /Users/lackey/Research/eosinference/bin/generate_likelihood.py \
...
python /Users/lackey/Research/eosinference/bin/generate_likelihood_plot_page.py \
--infile ${OUTDIR}/pseudolikelihood.hdf5 \
--outdir ${OUTDIR}

# Sample the prior
python /Users/lackey/Research/eosinference/bin/sample_distribution.py \
--infile ${OUTDIR}/pseudolikelihood.hdf5 \
...
python /Users/lackey/Research/eosinference/bin/calculate_ns_properties.py \
...
python /Users/lackey/Research/eosinference/bin/generate_eos_output_page.py \
